...
var _assetsBinConf = []byte("")

func assetsBinConfBytes() ([]byte, error) {
	return bindataRead(
		_assetsBinConf,
		"assets/bin.conf",
	)
...
func assetsBinConf() (*asset, error) {
	bytes, err := assetsBinConfBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "assets/bin.conf", size: 143, mode: os.FileMode(436), modTime: time.Unix(1452348380, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _assetsCssCss_assetCss = []byte("\x1f\x8b\x08\x00\x00\x09\x6e\x88\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")
...
func assetsCssCss_assetCss() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/css/css_asset.css", size: 0, mode: os.FileMode(436), modTime: time.Unix(1452348380, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"assets": &bintree{nil, map[string]*bintree{
		"bin.conf": &bintree{assetsBinConf, map[string]*bintree{}},
